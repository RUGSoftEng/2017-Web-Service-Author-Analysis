...
view translation =
    ...
    in
        div [ class "home maincontainer" ]
            [ header [ class "header", id "home", attribute "style" "min-height: 76px;" ] [ mainNav t (\_ -> ()) (Tuple.first <| Navbar.initialState (\_ -> ())) ]
                ...
                [ Grid.row [ Row.topXs ]
                    [ Grid.col [ textCenter, Col.attrs [ id "attribution-square" ] ]
                        [ a [ class "link-area", href "#/attribution" ]
                            [ div [ class "icon" ] []
                            , span [ class "title" ] [ text (t "attribution") ]
                            , span [ class "description" ] [ text (t "attribution-description") ]
                            ]
                        ]
                    , Grid.col [ textCenter, Col.attrs [ id "profiling-square" ] ]
                        [ a [ class "link-area", href "#/profiling" ]
                            [ div [ class "icon" ] []
                            , span [ class "title" ] [ text (t "profiling") ]
                            , span [ class "description" ] [ text (t "profiling-description") ]
                            ]
                        ]
                    ]
